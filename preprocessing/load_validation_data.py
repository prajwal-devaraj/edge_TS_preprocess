...
def build_validation_archive(validation_cycles_dict, global_median, global_iqr):
    """
    ...
    save_path = 'data/processed/validation_cycles.npz'
...
if __name__ == "__main__":
    ...
    build_validation_archive(val_cycles, global_median, global_iqr)